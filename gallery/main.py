...
def welcomeScreen():
    # Shows welcome images on welcome screen
    playerx = int(SCREENWIDTH/5)
    playery = int((SCREENHEIGHT - GAME_SPRITES['player'].get_height())/2)
    # messagex = int((SCREENWIDTH - GAME_SPRITES['message'].get_height())*2.4)
...
def mainGame():
    ...
    while True:
        ...
        # adding new pipe before first pipe is about to crossthe leftmost part of the screen
...
def getRandomPipe():
    '''
    generate positions of the two pipes for bltting on the screen
    '''
    pipeHeight = GAME_SPRITES['pipe'][0].get_height()
...
if __name__ == "__main__":
    # This is the main point from where out game starts
    pygame.init()
    FPSCLOCK = pygame.time.Clock()
    pygame.display.set_caption('Flappy Bird By Rohan Sharma')
